...
{
	glColor3f(0,0,1);
	bitmap_char(150, 665, "SORTING ALGORITHM VISUALIZATION USING OPENGL",GLUT_BITMAP_TIMES_ROMAN_24);


	// other text small font
	bitmap_char(10, 625, "This program sorts a random set of numbers in ascending order displaying them graphically as ",GLUT_BITMAP_9_BY_15);
	bitmap_char(10, 605, "bars with varying height",GLUT_BITMAP_9_BY_15);


	if (sorting == 0)	// if not sorting display menu
	{
		bitmap_char(10, 575, "MENU",GLUT_BITMAP_9_BY_15);
		bitmap_char(10, 555, "Press s to SORT",GLUT_BITMAP_9_BY_15);
		bitmap_char(10, 535, "Press c to SELECT the sort algorithm",GLUT_BITMAP_9_BY_15);
		bitmap_char(10, 515, "Press r to RANDOMISE",GLUT_BITMAP_9_BY_15);
		bitmap_char(10, 495, "Esc to QUIT",GLUT_BITMAP_9_BY_15);
		bitmap_char(10, 475, "Selected sort: ",GLUT_BITMAP_9_BY_15);
		bitmap_char(150, 475, *(sort_string+sort_count),GLUT_BITMAP_9_BY_15);
	}
	else if (sorting == 1)	// while sorting
	{
		glColor3f(0.5,0.5,0.5);
		bitmap_char(10, 555, "Sorting in progress...",GLUT_BITMAP_9_BY_15);
		bitmap_char(10, 535, "Press p to PAUSE",GLUT_BITMAP_9_BY_15);
...
{
	glColor3f(0.0,0.0,0.0);
	//bitmap_char(300, 565, "WELCOME!",GLUT_BITMAP_TIMES_ROMAN_24);
	//bitmap_char(330, 525, "TO",GLUT_BITMAP_TIMES_ROMAN_24);

	bitmap_char(150, 475, "SORTING ALGORITHM VISUALIZATION USING OPENGL",GLUT_BITMAP_TIMES_ROMAN_24);
	//glColor3f(1.0,0.0,0.0);
	//glBegin(GL_QUADS);
		//glVertex2f(520,120.0);glVertex2f(520,170);glVertex2f(796,170);glVertex2f(796,120.0);
	//glEnd();
	glColor3f(0.0,0.0,0.0);
	bitmap_char(530, 125, "Press Enter to continue.......",GLUT_BITMAP_HELVETICA_18);
}
...
void display()
{
	...
	if(k==0)
		...
		for(ix=0;ix<MAX;ix++)
		{
			...
			//printf("\n%s",text);
			glColor3f(0,0,0);
			bitmap_char(12+(700/(MAX+1))*ix, 35, text,GLUT_BITMAP_TIMES_ROMAN_10);
		}
